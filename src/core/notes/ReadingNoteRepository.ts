...
class ReadingNoteRepositoryService {
  /**
   * Retrieves all reading notes across all materials
   */
  ...
  /**
   * Retrieves all reading notes bound to a specific material ID
   */
  ...
  /**
   * Inserts or updates a Reading Note in persistent storage
   */
  ...
  /**
   * Deletes a Reading Note from storage
   */
