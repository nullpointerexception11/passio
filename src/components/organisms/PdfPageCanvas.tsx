...
import { HighlightToolbar } from '../molecules/HighlightToolbar';
    ...
    >
      ...
      <div
        ...
        className={`relative bg-white transition-shadow duration-300 ${
          viewMode === 'continuous'
            ? `rounded-none shadow-none border-b border-x ${pageNumber === 1 ? 'border-t' : ''} border-neutral-200 dark:border-neutral-800`
            : 'shadow-lg rounded-sm border border-neutral-200 dark:border-neutral-800'
        }`}
        style={{
